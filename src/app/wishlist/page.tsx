        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {items.length === 0 ? (
            <div className="text-center py-20 bg-white rounded-2xl border border-gray-200 shadow-sm">
              ...
              <h2 className="text-2xl font-bold tracking-tight mb-2">Your wishlist is empty</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {items.map((productId) => (
                <div key={productId} className="bg-white rounded-xl p-4 border border-gray-100 flex flex-col items-center justify-center min-h-[250px] shadow-sm relative group text-center">
                  <p className="font-semibold text-lg mb-4">Product ID: {productId}</p>
                  <Link href={`/shop/${productId}`} className="text-[#111] underline text-sm font-medium hover:text-gray-600 transition-colors">
                    View Item
                  </Link>
                  <button 
